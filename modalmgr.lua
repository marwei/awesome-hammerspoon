...
-- if clipboardM then
--     clipboardM_keys = clipboardM_keys or {{"option", "ctrl", "shift", "cmd"}, "P"}
...
--     aria2_keys = aria2_keys or {{"option", "ctrl", "shift", "cmd"}, "D"}
--     if string.len(aria2_keys[2]) > 0 then
--         modalmgr:bind({"option", "ctrl", "shift", "cmd"}, 'D', 'Launch aria2 Frontend', function()
